                                    ...
                                    <div class="form-label-group">
                                        @if($count_active >= 2)
                                            <div class="alert alert-warning">Sie haben ihre maximale Anzahl an aktiven Events erreicht.
                                                Deaktivieren oder löschen Sie zuerst ein Event um ein neues aktives Event erstellen zu können.</div>
                                            <input type="checkbox" name="status" value="aktive" data-toggle="tooltip" disabled> Event aktiv
                                        @elseif($count_inactive >= 5)
                                            <div class="alert alert-warning">Sie haben ihre maximale Anzahl an inaktiven Events erreicht.
                                                Aktivieren oder löschen Sie zuerst ein Event um ein neues inaktives Event erstellen zu können.</div>
                                            <input type="checkbox" name="status" value="aktive" data-toggle="tooltip" checked disabled> Event aktiv
                                        @else
